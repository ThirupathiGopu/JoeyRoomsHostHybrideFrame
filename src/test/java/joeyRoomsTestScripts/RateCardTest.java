...
import com.joeyroomHost.pages.Ratecard;
...
public class RateCardTest
{
	...
	@Test
	public void VerifuFunctionalityJoeyRoomsHostLoginwithValidaDataclickonratecard() throws Exception
	{
		...
		String email=info.get(0),pass=info.get(1);  
		 ...
		 Thread.sleep(5000);
		 rate.clickonRatecard();
		 Thread.sleep(4000);
		 rate.isdispalyTitel();
		 Thread.sleep(3000);
		 rate.ClickonAddratecard();
		 Thread.sleep(3000);
		 rate.clickonokbutton();
		 Thread.sleep(3000);
		 rate.clickondropdownAndselectproperty();
		 Thread.sleep(3000);
		 rate.selectdailyLink();
		 Thread.sleep(3000);
